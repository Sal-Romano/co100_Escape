// wipeReset.sqf - Client wipe cleanup. Kills camera FIRST, then blacks screen.

// STEP 1: Stop unconscious/camera systems
...
// STEP 6: Hammer 5 seconds - fn_createCam recreates HSC_View after 1.5s delay
[] spawn {
